            ...
            <div class="card-body">
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <th>Due Date</th>
                            <td><input type="date" name="due_date" value="<?= htmlspecialchars($project['due_date']) ?>"></td>
                        </tr>
                        <tr>
                            <th>Status</th>
                            <td><input type="text" name="status" value="<?= htmlspecialchars($project['status']) ?>"></td>
                        </tr>
                        <tr>
                            <th>Description</th>
                            <td><input type="text" name="description" value="<?= htmlspecialchars($project['description']) ?>"></td>
                        </tr>
                    </tbody>
                </table>
            </div>
